...
const ConfirmEmailModal: FC<{ isOpen: boolean, handleCloseButton: () => void }> = ({ isOpen, handleCloseButton }) => {
            ...
            <Dialog as="div" className="relative z-50" onClose={handleCloseButton}>
                ...
                <div className="fixed inset-0 overflow-y-auto">
                    <div className={`flex  items-center justify-center p-4 min-h-full text-center`}>
                        ...
                        >
                            <Dialog.Panel className={`w-full  transform overflow-hidden rounded-[30px] max-w-md bg-white p-6 text-left align-middle shadow-xl transition-all`}>
